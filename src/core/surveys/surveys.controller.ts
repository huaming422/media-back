...
export class SurveysController {
  ...
  async findOne(@Param('id') id: number) {
    return new SurveyEntity(await this.surveysService.findOne(id));
  }
  ...
  async addInfluencers(
    ...
    return serializeArray(
      this.surveysService.addInfluencers(id, influencerIds),
  ...
  async inviteInfluencers(
    ...
    return serializeArray(
      this.surveysService.inviteInfluencers(id, dto),
      PlatformProductOrderInfluencerEntity,
    );
  }
  ...
  async approveSurveyResult(
    ...
    return this.surveysService.approveSurveyResult(id, influencerIds);
  }
  ...
  async disapproveSurveyResult(
    ...
    return this.surveysService.disapproveSurveyResult(id, influencerIds);
  }
  ...
  @Put(':id/finishSurvey')
  @CacheInvalidate(...SurveysController.cacheInvalidateOnSurveyUpdate)
  async finishCampaign(@Param('id') id: number) {
  ...
  @CacheInvalidate(...SurveysController.cacheInvalidateOnSurveyUpdate)
  async createQuestion(@Param('id') id: number, dto: CreateQuestionDto) {
    return new QuestionEntity(
      await this.surveysService.createQuestion(id, dto),
    );
  }
  ...
  async getQuestions(@Param('id') id: number) {
    return serializeArray(
      this.surveysService.getQuestions(id, true),
      QuestionEntity,
    );
  }
  ...
  async updateQuestion(
    ...
    return new QuestionEntity(
      await this.surveysService.updateQuestion(questionId, dto),
    );
  }
