...
export class CampaignController {
  ...
  async inviteInfluencers(
    ...
    return serializeArray(
      this.campaignService.inviteInfluencers(id, dto),
      PlatformProductOrderInfluencerEntity,
    );
  }
  ...
  async approveSubmission(
    ...
    return this.campaignService.approveSubmission(id, influencerIds);
  }
  ...
  async disapproveSubmission(
    ...
    return this.campaignService.disapproveSubmission(id, influencerIds);
  }
